...
class Spreadsheet_Excel_Reader {
	...
	/**
	 *  $encoder = 'iconv' or 'mb'
	 *  set iconv if you would like use 'iconv' for encode UTF-8 to your encoding
	 *  set mb if you would like use 'mb_convert_encoding' for encode UTF-8 to your encoding
	 */
